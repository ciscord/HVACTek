...
+ (id) findFirstByAttribute:(NSString *) attribute withValue:(id) value createNewIfNotExists:(BOOL)createNewIfNotExists;
{
    NSManagedObject *entity = [self findFirstByAttribute:attribute withValue:value];
    if (!entity && createNewIfNotExists)
    {
