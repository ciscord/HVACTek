...
- (NSDictionary *)addDiscountsToDictionary:(NSDictionary *)dictionary {
  ...
  if ([NSNumber numberWithInt:[[self cutString:self.textFieldComfortClub.text] intValue]].intValue != 0) {
    ...
    if ([NSNumber numberWithInt:[[self cutString:self.textFieldDeposit.text] intValue]].intValue != 0){
        ...
        deposit.itemID = @"-2";
        deposit.amount     = [NSNumber numberWithFloat:-abs([[self cutString:self.textFieldDeposit.text] floatValue])];
        deposit.amountESA = [NSNumber numberWithFloat:-abs([[self cutString:self.textFieldDeposit.text] floatValue])];
    ...
    if ([NSNumber numberWithInt:[[self cutString:self.textFieldDisconts.text] intValue]].intValue != 0) {
        ...
        discount.itemID = @"-3";
        discount.amount     = [NSNumber numberWithFloat:-abs([[self cutString:self.textFieldDisconts.text] floatValue])];
        discount.amountESA = [NSNumber numberWithFloat:-abs([[self cutString:self.textFieldDisconts.text] floatValue])];
    ...
    if ([NSNumber numberWithInt:[[self cutString:self.textFieldPayment.text] intValue]].intValue != 0) {
        PricebookItem *payment = [PricebookItem new];
        payment.itemID = @"-4";
        payment.amount     = [NSNumber numberWithFloat:-abs([[self cutString:self.textFieldPayment.text] floatValue])];
        payment.amountESA = [NSNumber numberWithFloat:-abs([[self cutString:self.textFieldPayment.text] floatValue])];
